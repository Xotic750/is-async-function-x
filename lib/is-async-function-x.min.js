 ...
 */
"use strict";var asyncProto,toStringTag=_dereq_("to-string-tag-x"),hasToStringTag=_dereq_("has-to-string-tag-x"),normalise=_dereq_("normalize-space-x"),isFnRegex=new RegExp("^async function"),replaceComments=_dereq_("replace-comments-x"),fToString=Function.prototype.toString,$getPrototypeOf=_dereq_("get-prototype-of-x"),supportsAsync=!1;try{asyncProto=$getPrototypeOf(Function("return async function() {}")()),supportsAsync=!0}catch(ignore){}module.exports=function isAsyncFunction(fn){if(!1===supportsAsync||"function"!=typeof fn)return!1;var str;try{str=normalise(replaceComments(fToString.call(fn)," "))}catch(ignore){return!1}return!!isFnRegex.test(str)||(!1===hasToStringTag?"[object AsyncFunction]"===toStringTag(fn):$getPrototypeOf(fn)===asyncProto)}},{"get-prototype-of-x":2,"has-to-string-tag-x":4,"normalize-space-x":11,"replace-comments-x":12,"to-string-tag-x":15}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";module.exports=_dereq_("has-symbol-support-x")&&"symbol"==typeof Symbol.toStringTag},{"has-symbol-support-x":3}],5:[function(_dereq_,module,exports){/**
