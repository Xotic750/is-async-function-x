 ...
 */
"use strict";var toStringTag=_dereq_("to-string-tag-x"),hasToStringTag=_dereq_("has-to-string-tag-x"),normalise=_dereq_("normalize-space-x").normalizeSpace2018,isFnRegex=/^async function/,test=isFnRegex.test,replaceComments=_dereq_("replace-comments-x"),functionCtr=function(){}.constructor,fToString=functionCtr.prototype.toString,$getPrototypeOf=_dereq_("get-prototype-of-x"),testRes=_dereq_("attempt-x")(function(){return $getPrototypeOf(functionCtr("return async function() {}")())}),supportsAsync=!1===testRes.threw,asyncProto=testRes.value;module.exports=function isAsyncFunction(fn){if(!1===supportsAsync||"function"!=typeof fn)return!1;var str;try{str=normalise(replaceComments(fToString.call(fn)," "))}catch(ignore){return!1}return!!test.call(isFnRegex,str)||(!1===hasToStringTag?"[object AsyncFunction]"===toStringTag(fn):$getPrototypeOf(fn)===asyncProto)}},{"attempt-x":2,"get-prototype-of-x":4,"has-to-string-tag-x":6,"normalize-space-x":13,"replace-comments-x":14,"to-string-tag-x":19}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":16,"to-string-x":20}],16:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var castString="".constructor,isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return castString(value)}},{"is-symbol":11}],21:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),Rx=_dereq_("cached-constructors-x").RegExp,reRight2016=new Rx("["+_dereq_("white-space-x").string2016+"]+$"),reRight2018=new Rx("["+_dereq_("white-space-x").string2018+"]+$"),replace="".replace,$trimRight2018=function trimRight2018(string){return replace.call(requireCoercibleToString(string),reRight2018,"")};module.exports={trimRight:$trimRight2018,trimRight2016:function trimRight2016(string){return replace.call(requireCoercibleToString(string),reRight2016,"")},trimRight2018:$trimRight2018}},{"cached-constructors-x":3,"require-coercible-to-string-x":15,"white-space-x":25}],23:[function(_dereq_,module,exports){/**
